...
class PadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Landlord.index', compact('pads'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pads.index')->with('success', 'Pad created successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pads.index')->with('success', 'Pad updated successfully!');
    }
    ...
    public function destroy($id)
    {
        $pad = \App\Models\Pad::findOrFail($id);
        $pad->delete();
        return redirect()->route('pads.index')->with('success', 'Pad deleted successfully!');
    }

    public function show($id)
    {
        $pad = \App\Models\Pad::findOrFail($id);
        return view('Landlord.show', compact('pad'));
    }
}
